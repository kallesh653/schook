...
const NoticeStudent = () => {
  ...
  const getNoticeStats = () => {
    ...
    const important = notices.filter(notice =>
      notice.audience?.toLowerCase() === 'important'
    ).length;

    return { total, recent, important };
  };
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 2, md: 4 }, px: { xs: 1, md: 3 } }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={4}>
          <StatsCard sx={{ background: 'linear-gradient(45deg, #4CAF50 30%, #8BC34A 90%)' }}>
            <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 1 }}>
              {stats.recent}
            </Typography>
            <Typography variant="body2" sx={{ opacity: 0.9 }}>
        ...
        <Grid item xs={12} sm={4}>
          <StatsCard sx={{ background: 'linear-gradient(45deg, #FF9800 30%, #FFC107 90%)' }}>
            <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 1 }}>
              {stats.important}
            </Typography>
            <Typography variant="body2" sx={{ opacity: 0.9 }}>
