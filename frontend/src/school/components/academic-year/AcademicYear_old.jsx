...
const AcademicYear = () => {
    ...
    const handlePromoteStudents = async () => {
        ...
        try {
            ...
            showSnackbar('Students promoted successfully', 'success');
            ...
            <Dialog open={openPromoteDialog} onClose={() => setOpenPromoteDialog(false)} maxWidth="md" fullWidth>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Alert severity="info" sx={{ mb: 2 }}>
                                Select students from {fromYear} to promote to the next academic year.
                            </Alert>
                        </Grid>
                ...
                <DialogActions>
                    ...
                    <Button
                        ...
                        disabled={loading || selectedStudents.length === 0 || !toYear}
