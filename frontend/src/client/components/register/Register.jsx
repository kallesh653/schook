...
const resetMessage  =()=>{
    ...
    return (<Box component={'div'} className="register-container">

<Box component={'div'} className="register-content"> 
    {message && <CustomizedSnackbars reset={resetMessage} type={type} message={message}/>}
        <Box className="register-header" component={'div'}>
            <Typography variant="h3" className="register-title">Create School Account</Typography>
            <Typography variant="body1" className="register-subtitle">Join our education platform</Typography>
        </Box>
